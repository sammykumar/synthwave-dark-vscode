...
function activate(context) {
	...
	let disposable = vscode.commands.registerCommand('synthwaveDark.enableNeon', function () {
	...
	let disable = vscode.commands.registerCommand('synthwaveDark.disableNeon', uninstall);
